    ...
    <div className="flex md:justify-center p-12 md:p-4">
      <div className="flex-col-reverse flex justify-center md:flex-row items-center">
        <div className="space-y-4 md:pr-16">
          <p className="uppercase tracking-[0.2em] text-xs"> Hey there! I'm</p>
          ...
          <p className="max-w-2xl md:text-left text-center">
            ...
            also have a blog and a YouTube channel where I talk about tech! At
            the moment, coding is a hobby of mine, but I'm intent on expanding
            it into a career in the future!
          </p>
        </div>
        <Image
